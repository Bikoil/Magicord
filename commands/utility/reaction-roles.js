    ...
    data: new SlashCommandBuilder()
        ...
        .addRoleOption(option =>
            option.setName('role1')
                .setDescription('The first role (be careful what role you offer)')
                .setRequired(true))
        .addRoleOption(option =>
            option.setName('role2')
                .setDescription('The second role (be careful what role you offer)')
                .setRequired(true))
        .addRoleOption(option =>
            option.setName('role3')
                .setDescription('The third role(be careful what role you offer)')
                .setRequired(true))
